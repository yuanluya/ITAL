...
def main():
    ...
    if not feature_extraction:
        ...
        np.save('CUB200_train_features%d.npy' % resnet_idx, train_feat)
        np.save('CUB200_test_features%d.npy' % resnet_idx, test_feat)
        np.save('CUB200_gt_weights%d.npy' % resnet_idx, W)
